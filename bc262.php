...
// Filename safe
$filenameSafe = preg_replace('/[^0-9A-Za-z\-]/', '_', v($data, 'nomor_pengajuan', 'BC262'));
...
<head>
    <meta charset="utf-8">
    <title>BC262 - <?= htmlspecialchars(v($data, 'nomor_pengajuan', '-'), ENT_QUOTES, 'UTF-8') ?></title>
    <style>
        @page {
