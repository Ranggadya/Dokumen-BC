...
<table class="b1">
    <!-- TITLE -->
    <tr>
        <td class="b1 center titleBC" style="width:18%; padding-top: 4mm; text-align: center;">BC 4.1</td>
    ...
    <tr>
        ...
        <td class="b1 bt0" colspan="2" style="padding:0;">
            <table style="width:100%; table-layout:fixed; border-collapse:collapse;">
                ...
                <tr>
                    <!-- kiri kosong -->
                    <td style="width:51%; padding: 1.2mm 1.2mm; border-bottom:0.5pt solid #000;"></td>

                    <!-- judul di kolom kanan -->
                    <td style="width:49%; padding: 1.2mm 1.2mm; border-bottom:0.5pt solid #000; text-align:left;">
                ...
                <tr>
                    <!-- kolom kiri kosong -->
                    <td style="width:51%; padding:0; height:40mm;"></td>

                    <!-- kolom kanan -->
                    <td style="width:49%; padding: 1.8mm 1.8mm; vertical-align:top; height:40mm;">
